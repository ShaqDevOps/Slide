...
<div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
    <div class="main-left">
        ...
        <div class = "p-12 bg-white border border-gray-200 rounded-lg">
            ...
            <p class = "mb-6 text-gray-500">TestTestTestTestTestTestTestTestTestTest\TestTest
                TestTestTestTestTestTestTestTestTes
                tTestTestTestTestTestTest
            </p>
            <p class="font-bold">
                Already have an account? <a href="/login" class="underline"> Click here</a> to log in!
            </p>
            </div>
    ...
    <div class="main-right">
        ...
        <div class = "p-12 bg-white border border-gray-200 rounded-lg">
            <form class="space-y-6">
                <div>
                    <label>Name</label><br>
                    <input type="name" placeholder="Your full name"  class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                </div>
                <div>
                    <label>Username</label><br>
                    <input type="username" placeholder="Name of your page"  class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                </div>
                <div>
